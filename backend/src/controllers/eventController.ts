 ...
 */
export const cancelEventHandler: RequestHandler = async (req, res) => {
 ...
 */
export const registerForEventHandler: RequestHandler = async (req, res) => {
  const eventId = req.params['id'];
 ...
 */
export const leaveEventHandler: RequestHandler = async (req, res) => {
  const eventId = req.params['id'];
  const { userId } = req.body;
